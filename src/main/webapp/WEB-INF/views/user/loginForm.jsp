...
<body>
	...
	<div class="container">
		<form action="/auth/loginProc" method="post">
			...
			<a href="https://kauth.kakao.com/oauth/authorize?client_id=d57f1da2dba0639dd027db4544ed062d&redirect_uri=http://localhost:8088/auth/kakao/callback&response_type=code">
